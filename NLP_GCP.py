...
def nat_lang_analysis(text_content):
    upload_blob("102619hackgtaudio",text_content,text_content)

    storage_uri = "gs://102619hackgtaudio/" + text_content

    WORDS, WIKI = sample_analyze_entities(storage_uri)
...
if __name__ == "__main__":
    ...
    text_content = r"C:\Users\vivek\Dropbox (GaTech)\Projects\HackGT\fin_text_example.txt"
    nat_lang_analysis(text_content)
